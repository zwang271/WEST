...
TEST(test_vectors_equal) {
    vector<string> v1 = {"s1, ss"};
    vector<string> v2 = {"s1, ss"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_2) {
    vector<string> v1 = {"s1,ss"};
    vector<string> v2 = {"s1,ss,ss"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_3) {
    vector<string> v1 = {"s1,ss"};
    vector<string> v2 = {"s1,ss", "ss,11"};
    ASSERT_FALSE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_4) {
    vector<string> v1 = {"s1,ss"};
    vector<string> v2 = {"s1,ss,ss,ss"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_5) {
    vector<string> v1 = {"s1,ss,ss,ss"};
    vector<string> v2 = {"s1,ss,ss"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_6) {
    vector<string> v1 = {"s1", "00", "11"};
    vector<string> v2 = {"s1", "00", "11"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}

TEST(test_vectors_equal_7) {
    vector<string> v1 = {"s1", "11", "00"};
    vector<string> v2 = {"s1", "00", "11"};
    ASSERT_TRUE(check_vectors_equal(&v1, &v2, 2));
}
