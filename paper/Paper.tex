...
$$\alpha := \top \ | \ \bot \ | \ p \ | \ \neg \alpha \ | \ \alpha \land \alpha \ | \ \alpha \lor \alpha \ | \ \mathcal{F}_{[a,b]} \alpha \ | \ \mathcal{G}_{[a,b]} \alpha \ | \ \alpha \mathcal{U}_{[a,b]} \alpha \ | \ \alpha \mathcal{R}_{[a,b]} \alpha \footnote{For simplicity, we do not include parentheses in the grammar, but the WEST program requires parentheses (see Section \ref{specs}). We encode the Release operator directly rather than as the dual of Until \cite{bmc,LVR22}.}$$
