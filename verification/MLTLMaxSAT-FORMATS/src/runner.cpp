...
int main(int argc, char *argv[])
{
    //================================
    // UPDATE THESE:
    string prefix = "/work/kyrozier/gokul/";
    ...
    string tempMaxBound = prefix + "MAXSAT_MLTL/maxbound.txt";
    string tempSmvFile = prefix + "temp.smv";

    ifstream infile(prefix + "MAXSAT_MLTL/Translators/Benchmarks/MLTLSatisfiability/randomList.mltl");
    ofstream ouic3(prefix + "MAXSAT_MLTL/Translators/BenchmarkResults/randomList.ic3");
    ofstream oubmc(prefix + "MAXSAT_MLTL/Translators/BenchmarkResults/randomList.bmc");
    // doing ic3 check:
    string line;
